...
class TestOrderFeed:
    ...
    def test_click_on_order_from_feed(self, driver):
    ...
    def test_check_user_order_in_order_feed(self, driver, order):
        page = OrderFeedPage(driver)
    ...
    def test_check_all_completed_orders_counter(self, driver, register):
        page = OrderFeedPage(driver)
    ...
    def test_check_today_completed_orders_counter(self, driver, register):
        page = OrderFeedPage(driver)
    ...
    def test_check_order_number(self, driver, order):
        page = OrderFeedPage(driver)
