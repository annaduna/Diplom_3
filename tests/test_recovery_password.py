...
class TestCheckRecoveryPassword:
    ...
    def test_open_recovery_password_page_by_button_click(self):
        page = LoginPage()
        page.click_on_recovery_password_button()
        assert urls.FORGOT_PASSWORD_PAGE_URL == page.get_current_url()

    @allure.title('Ввод почты и клик по кнопке «Восстановить»')
    def test_input_email_input_and_click_recovery_password(self):
    ...
    def test_password_field_focused_if_press_show_password(self):
        page = RecoveryPasswordPage()
        page.input_email_and_click_recovery_button()
